...
function ohSnap(text, options) {
  var defaultOptions = {
    ...
    'fade-duration': '500',  // duration of the fade in/out of the alerts. fast, slow or integer in ms
  }
  ...
  var $container = $('#'+options['container-id']),
    ...
    // Generate the HTML
    var html = $('<div style="display: none;" class="alert ' + color_markup + '">' + icon_markup + text + '</div>');
